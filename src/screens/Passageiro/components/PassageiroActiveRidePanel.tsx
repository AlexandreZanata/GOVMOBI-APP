 ...
 * Shows driver name + vehicle strip, status, addresses, cancel section, and chat FAB.
 */
...
export const PassageiroActiveRidePanel = ({
  ...
  const showDriverStrip = DRIVER_ASSIGNED.has(corrida.status) && (motoristaNome ?? veiculoLabel);
  ...
  return (
    <>
      <View
        ...
        {/* Driver strip — shown when driver is assigned */}
        {showDriverStrip ? (
        ...
        {/* Divider between driver strip and route */}
        {showDriverStrip ? <View style={styles.driverStripDivider} /> : null}
