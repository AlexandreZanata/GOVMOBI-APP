...
| [`route-corridas-motorista.md`](./route-corridas-motorista.md) | Corridas (Motorista)         | `/corridas/*`       |
...
| [`route-pesquisa-geocoding.md`](./route-pesquisa-geocoding.md) | Search / Geocoding / Routing | `/pesquisa/*`       |
...
4. `route-cargos.md` — establishes the envelope unwrap pattern
5. `route-lotacoes.md` — identical pattern to Cargos, fast to implement
6. `route-servidores.md` — depends on Cargos and Lotações (foreign keys)
7. `route-frota-motoristas.md` — depends on Servidores (`servidorId`) and adds status flow
8. `route-frota-veiculos.md` — note: soft-delete is PATCH /desativar, not DELETE
9. `route-users.md`
10. `route-departments.md`
11. `route-audit.md` — read-only, implement last
